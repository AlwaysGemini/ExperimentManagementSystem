...
public final class DensityUtils {
    ...
    public static DisplayMetrics getDisplayMetrics() {
        return getDisplayMetrics(MyApplication.getContext());
    }
    ...
    public static int dip2px(float dpValue) {
        return dip2px(MyApplication.getContext(), dpValue);
    }
    ...
    public static int px2dip(float pxValue) {
        return px2dip(MyApplication.getContext(), pxValue);
    }
    ...
    public static int sp2px(float spValue) {
        return sp2px(MyApplication.getContext(), spValue);
    }
    ...
    public static int px2sp(float pxValue) {
        return px2sp(MyApplication.getContext(), pxValue);
    }
    ...
    public static float applyDimension(final float value, final int unit) {
        return applyDimension(MyApplication.getContext(), value, unit);
    }
