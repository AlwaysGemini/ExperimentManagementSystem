...
import com.gemini.always.experimentmanagementsystem.bean.insertBean.InsertRulesOfSelectingCourses;
import com.gemini.always.experimentmanagementsystem.bean.queryBean.QueryRulesOfSelectingCourses;
import com.gemini.always.experimentmanagementsystem.bean.tableBean.CourseExperimentOutlineTable;
import com.gemini.always.experimentmanagementsystem.bean.tableBean.RulesOfSelectingCoursesTable;
...
import com.gemini.always.experimentmanagementsystem.presenter.RulesOfSelectingCoursesPresenter;
...
public class RulesOfSelectingCoursesFragment extends BaseFragment<BaseCURDView, RulesOfSelectingCoursesPresenter> implements BaseCURDView {
    ...
    private String title = "选课规则设置";
    private Class tableClass = RulesOfSelectingCoursesTable.class;
    private Class queryClass = QueryRulesOfSelectingCourses.class;
    private Class insertClass = InsertRulesOfSelectingCourses.class;
    ...
    @Override
    public RulesOfSelectingCoursesPresenter createPresenter() {
        return new RulesOfSelectingCoursesPresenter();
    }
    ...
    @OnClick({R.id.fab_delete, R.id.fab_import, R.id.fab_export, R.id.fab_add, R.id.fab_query})
