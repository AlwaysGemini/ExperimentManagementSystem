...
public class LaboratoryRoomFragment extends BaseFragment<LaboratoryRoomView, LaboratoryRoomPresenter> implements LaboratoryRoomView, View.OnClickListener {
    ...
    public void onResume() {
        super.onResume();
        table.setData(list, LaboratoryRoomTable.class);
    }
        ...
        switch (view.getId()) {
            case R.id.fab_query:
                new CustomDialog.Builder(getContext())
                        .setTitle("查询")
                        .setSpinnerTextList(Arrays.asList(getResources().getStringArray(R.array.laboratoryRoomSpinnerTextListForQuery)))
                        ...
                        new Thread() {
                            ...
                            public void run() {
                                if (FileUtils.getFormatName(filePath).equals("xlsx")) {
                                    ...
                                    List<LaboratoryRoomTable> list = ExcelUtils.readExcelContent(filePath, LaboratoryRoomTable.class);
            ...
            case R.id.fab_add:
                new CustomDialog.Builder(getContext())
                        .setTitle("增加")
                        .setEditList(Arrays.asList(getResources().getStringArray(R.array.laboratoryRoomTextListForInsert)))
                        .serOnPositive("确定", new CustomDialog.DialogIF() {
                            @Override
                            public void onPositive(CustomDialog dialog, List<String> list) {
